...
See [`CLAUDE.md`](../CLAUDE.md) — the live file, loaded into every Claude Code
session alongside this doc. Deliberately not duplicated here: a second copy
drifts out of date, and both files load together, so drift means contradictory
instructions.
